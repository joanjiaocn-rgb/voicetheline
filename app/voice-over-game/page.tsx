  ...
  return (
    <main className="content-page">
      <header className="content-header">
        ...
        <a className="content-header-link" href="/#studio">Play the game <span aria-hidden="true">-&gt;</span></a>
      </header>
      ...
      <section className="content-hero">
        <div className="content-hero-copy">
          ...
          <div className="content-actions"><a className="content-button primary" href="/#studio">Play online</a><a className="content-button secondary" href="#scene-library">Browse scenes</a></div>
        </div>
      ...
      <section className="guide-section" aria-labelledby="how-to-play-title">
        <div className="guide-section-heading"><span className="section-kicker">How it works</span><h2 id="how-to-play-title">A simple voice acting practice loop</h2><p>Every scene keeps the useful parts of a recording session in one place: a clear visual, an active cue, and a take you can hear back.</p></div>
      ...
      <section className="guide-section guide-faq" aria-labelledby="guide-faq-title">
        <div className="guide-section-heading"><span className="section-kicker">Questions before your take</span><h2 id="guide-faq-title">Voice over game FAQ</h2></div>
      ...
      <footer className="content-footer"><div><strong>VOICE THE LINE</strong><span>Original scenes for your next take.</span></div><nav aria-label="Footer navigation"><a href="/#studio">Play online</a><a href="/privacy/">Privacy</a><a href="/terms/">Terms</a></nav></footer>
